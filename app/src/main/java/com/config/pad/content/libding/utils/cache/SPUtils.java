package com.config.pad.content.libding.utils.cache;
...
import com.config.pad.content.libding.config.application.PadApplication;
...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = PadApplication.getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = PadApplication.getContext().getSharedPreferences(spName, mode);
    }
