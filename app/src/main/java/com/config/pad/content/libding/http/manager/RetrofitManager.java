...
import static com.config.pad.content.libding.http.ApiService.SERVER_ADDRESS;
...
public class RetrofitManager {
    ...
    private Interceptor mLoggingInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            LogUtils.v(TAG, "-----------------------开始打印请求数据-----------------------");
            if (request != null) {
                LogUtils.w(TAG+"发送请求:", request.toString());
            ...
            if (contentType != null) {
                try {
                    ...
                    LogUtils.d(TAG, "Couldn't decode the response body; charset is likely malformed.");
                    return response;
            ...
            if (contentLength != 0) {
                ...
                LogUtils.e(TAG+"响应数据:", buffer.clone().readString(charset));
            ...
            iTestJson.showJson(responseString);
            return response;

        }
    };

    public interfaceUtilsAll.TestJson iTestJson = null;
    public void setTestJson(interfaceUtilsAll.TestJson iTestJson) {
        this.iTestJson = iTestJson;
    }
    ...
    //
    public Observable<GetListRsp> getGetListRspObservable(Map<String, String> params) {
    ...
    //
    public Observable<PostListRsp> getPostListRspObservable(Map<String, String> params) {
        return apiService.requestPostListRspList(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io());
    }
    //GetMvpRsp
    public Observable<GetMvpRsp> getGetMvpRspObservable(Map<String, String> params) {
        return apiService.requestGetMvpRspList(params)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .unsubscribeOn(Schedulers.io());
    }
